...
const TITLES = ['Backend Developer', 'AI Developer', 'Full Stack Learner']
      ...
      <div className="section-container relative z-10 text-center max-w-4xl flex flex-col items-center">
        ...
        <div className="hero-btns opacity-0 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-5 mb-10 sm:mb-12">
          <a
            ...
            className="px-8 py-3.5 rounded-xl bg-accent text-white font-semibold glow-btn flex items-center gap-2 text-sm sm:text-base"
          ...
          <a
            href="#"
            className="px-8 py-3.5 rounded-xl border border-border text-text hover:bg-white/5 transition-colors font-semibold flex items-center gap-2 text-sm sm:text-base"
            id="hero-cta-resume"
          >
        ...
        <div className="hero-socials opacity-0 flex items-center justify-center gap-4">
          {[
            ...
            <a
              ...
              aria-label={s.label}
              className="w-11 h-11 rounded-xl border border-border flex items-center justify-center text-text-muted hover:text-accent hover:border-accent-glow/40 transition-all hover:shadow-[0_0_20px_-5px_rgba(99,102,241,0.3)]"
            >
