                ...
                >
                  ...
                  <div className="ml-10 md:ml-0 md:w-1/2">
                    <div className="glass rounded-2xl p-7 md:p-8 glow-border-hover transition-all duration-300 hover:-translate-y-1">
                      ...
                      <p className="text-sm font-medium text-accent-bright mb-3">
                        {exp.company}
                      </p>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {exp.tech.map((t) => (
                          <span
                            key={t}
                            className="px-2.5 py-0.5 text-xs font-mono rounded-full bg-surface text-text-dim border border-border"
                          >
                            {t}
                          </span>
                        ))}
