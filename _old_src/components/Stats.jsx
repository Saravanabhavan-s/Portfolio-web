...
export default function Stats() {
  ...
  return (
    <section ref={sectionRef} className="py-20 md:py-24 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-5 md:gap-7">
          {STATS.map((stat, i) => (
            <div
              ...
              className="glass rounded-2xl min-h-[170px] sm:min-h-[185px] p-7 sm:p-8 md:p-9 text-center glow-border-hover transition-all duration-300 hover:-translate-y-1 group flex flex-col items-center justify-center"
            >
