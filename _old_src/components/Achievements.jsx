...
export default function Achievements() {
  ...
  return (
    <section ref={sectionRef} className="py-20 md:py-24 relative z-10" id="achievements">
      <div className="section-container">
        ...
        >
          {ACHIEVEMENTS.map((item) => (
            <div
              key={item.title}
              className="glass rounded-2xl p-8 md:p-9 glow-border-hover transition-all duration-300 hover:-translate-y-1 group"
            >
